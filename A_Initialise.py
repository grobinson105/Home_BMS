...
dbLoc = "/mnt/usb/BMS2" #"/media/HeatSet_BMS/" #'C:\\Users\\grobi\\OneDrive\\Documents\\George\\Home Energy Monitoring v2\\v2\\Home_BMS\\'
fileLoc = "/home/room1/Home_BMS/" #"/home/pi/Home_BMS/" #'C:\\Users\\grobi\\OneDrive\\Documents\\George\\Home Energy Monitoring v2\\v2\\Home_BMS\\'
...
lngGraphBtnHeight = int(lngScreenDesignHeight / 15 * lngScreenHeightADJ)
...
dictCommonGUIParams = {'GUI_BMS': None,
                        ...
                        'Logo_x': frmLogo_x,
                        'Logo_y': frmLogo_y,
                        'Graph_button_height': lngGraphBtnHeight,
                        'DB_Name': 'HeatSetDB_'}
...
dictSolarPumpElectrictyLoad = {'ID':21,
                        ...
                        'GUI_Label': 'Pump electricity consumption day (Wh)',
                        'GUI_Val': None,
                        'GUI_Default': 0,
                        'Sensor': False,
                        'Pulse_Meter': True,
...
frmSolarGraphHeight = lngScreenHeight - lngGraphBtnHeight
frmSolarGraphWidth = lngScreenWidth - frmLogoWidth
frmSolarGraph_x = frmSolarSensorsWidth
frmSolarGraph_y = 0 + lngGraphBtnHeight
...
frm_Solar_Graph_title = dt.datetime.now().strftime("%d/%m/%Y")
...
frmHPGraphHeight = lngScreenHeight - lngGraphBtnHeight
frmHPGraphWidth = lngScreenWidth - frmLogoWidth
frmHPGraph_x = frmHPSensorsWidth
frmHPGraph_y = lngGraphBtnHeight
...
#HP GRAPH 1
frm_HP_Graph1_bd = 1
bx_HP_Graph1_width = frmHPGraphWidth
bx_HP_Graph1_height = frmHPGraphHeight-40
bx_HP_Graph1_x0 = 0
bx_HP_Graph1_y0 = 0
tm_HP_Graph1_length = 5 #pixel length of the minor tm line
tm_HP_Graph1_major_length = 10 #pixel length of the major tm line
tm_HP_Graph1_x_count = 24*2 #Show tickmarks each half hour
tm_HP_Graph1_x_major = 2 #Show major tm on the hour
HP_Graph1_x_max = 24 #maximum value of x axis is 24th hour
HP_Graph1_x_min = 0 #minimum value on the x axis in the 0th hour
tm_HP_Graph1_y_count = 100 #Maximum on graph assumes no more than 10 hours @ maximum capacity (which would be excessive!)
tm_HP_Graph1_y_major= 5 #Show major tm for every Wh
HP_Graph1_y_max = 100000 #Maximum wh per day
HP_Graph1_y_min = 0 #Minimum capacity on y-axisis 0 kWh
frm_HP_Graph1_title = dt.datetime.now().strftime("%d/%m/%Y")
boolGrid_HP_Graph1 = True
HP_Graph1_x_title = 'Time (hour of day)'
HP_Graph1_y_title = 'Cumulative energy transfer (Wh)'

dict_HP_Graph1_Frame_Dims = {'frm_width': frmHPGraphWidth,
                                'frm_height': frmHPGraphHeight,
                                'frm_bd': frm_HP_Graph1_bd,
                                'bx_width': bx_HP_Graph1_width,
                                'bx_height': bx_HP_Graph1_height,
                                'bx_x0': bx_HP_Graph1_x0,
                                'bx_y0': bx_HP_Graph1_y0}
dict_HP_Graph1_Values = {'include_grid': boolGrid_HP_Graph1,
                                'graph_x_title': HP_Graph1_x_title,
                                'graph_x_max': HP_Graph1_x_max,
                                'graph_x_min': HP_Graph1_x_min,
                                'graph_y_title': HP_Graph1_y_title,
                                'graph_y_max': HP_Graph1_y_max,
                                'graph_y_min': HP_Graph1_y_min,
                                'tm_length': tm_HP_Graph1_length,
                                'tm_x_count': tm_HP_Graph1_x_count,
                                'tm_x_major': tm_HP_Graph1_x_major,
                                'tm_y_count': tm_HP_Graph1_y_count,
                                'tm_y_major': tm_HP_Graph1_y_major,
                                'tm_major_length': tm_HP_Graph1_major_length,
                                'frm_title':frm_HP_Graph1_title}
dict_HP_Graph1_Instructions = {'Dimensions': dict_HP_Graph1_Frame_Dims, 'Values': dict_HP_Graph1_Values}

#HP GRAPH 2
frm_HP_Graph2_bd = 1
bx_HP_Graph2_width = frmHPGraphWidth
bx_HP_Graph2_height = frmHPGraphHeight-40
bx_HP_Graph2_x0 = 0
bx_HP_Graph2_y0 = 0
tm_HP_Graph2_length = 5 #pixel length of the minor tm line
tm_HP_Graph2_major_length = 10 #pixel length of the major tm line
tm_HP_Graph2_x_count = 24*2 #Show tickmarks each half hour
tm_HP_Graph2_x_major = 2 #Show major tm on the hour
HP_Graph2_x_max = 24 #maximum value of x axis is 24th hour
HP_Graph2_x_min = 0 #minimum value on the x axis in the 0th hour
tm_HP_Graph2_y_count = 60 #Maximum on graph assumes no more than 10 hours @ maximum capacity (which would be excessive!)
tm_HP_Graph2_y_major= 5 #Show major tm for every Wh
HP_Graph2_y_max = 60 #Maximum wh per day
HP_Graph2_y_min = 0 #Minimum capacity on y-axisis 0 kWh
frm_HP_Graph2_title = dt.datetime.now().strftime("%d/%m/%Y")
boolGrid_HP_Graph2 = True
HP_Graph2_x_title = 'Time (hour of day)'
HP_Graph2_y_title = 'Temperature (DegC)'

dict_HP_Graph2_Frame_Dims = {'frm_width': frmHPGraphWidth,
                                'frm_height': frmHPGraphHeight,
                                'frm_bd': frm_HP_Graph2_bd,
                                'bx_width': bx_HP_Graph2_width,
                                'bx_height': bx_HP_Graph2_height,
                                'bx_x0': bx_HP_Graph2_x0,
                                'bx_y0': bx_HP_Graph2_y0}
dict_HP_Graph2_Values = {'include_grid': boolGrid_HP_Graph2,
                                'graph_x_title': HP_Graph2_x_title,
                                'graph_x_max': HP_Graph2_x_max,
                                'graph_x_min': HP_Graph2_x_min,
                                'graph_y_title': HP_Graph2_y_title,
                                'graph_y_max': HP_Graph2_y_max,
                                'graph_y_min': HP_Graph2_y_min,
                                'tm_length': tm_HP_Graph2_length,
                                'tm_x_count': tm_HP_Graph2_x_count,
                                'tm_x_major': tm_HP_Graph2_x_major,
                                'tm_y_count': tm_HP_Graph2_y_count,
                                'tm_y_major': tm_HP_Graph2_y_major,
                                'tm_major_length': tm_HP_Graph2_major_length,
...
frmPVGraphHeight = lngScreenHeight - lngGraphBtnHeight
frmPVGraphWidth = lngScreenWidth - frmLogoWidth
frmPVGraph_x = frmPVSensorsWidth
frmPVGraph_y = lngGraphBtnHeight
...
frm_PV_Graph_title = dt.datetime.now().strftime("%d/%m/%Y")
...
frmBATGraphHeight = lngScreenHeight - lngGraphBtnHeight
frmBATGraphWidth = lngScreenWidth - frmLogoWidth
frmBATGraph_x = frmBATSensorsWidth
frmBATGraph_y = lngGraphBtnHeight
...
BAT_Graph_y_max = 20000 #Maximum Wh in a day
BAT_Graph_y_min = 0 #Minimum charge/discharge on y-axisis 0 Wh
frm_BAT_Graph_title = dt.datetime.now().strftime("%d/%m/%Y")
...
frmZONEGraphHeight = lngScreenHeight - lngGraphBtnHeight
frmZONEGraphWidth = lngScreenWidth - frmLogoWidth
frmZONEGraph_x = frmZONESensorsWidth
frmZONEGraph_y = lngGraphBtnHeight
...
frm_ZONE_Graph_title = dt.datetime.now().strftime("%d/%m/%Y")
